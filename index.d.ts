...
import { PluginConfig, Repository, LicenseInfo } from './types';
...
declare function aggregateFiles(moduleIds: Array<string>, packerFunction?: (content: Buffer | ReadStream | string, name: string) => void, filter?: RegExp | string): Promise<import("./types").License[]>;
